...
Everything in "Platform map" through "Trust boundaries" below describes what
`main` already implements (verified by reading `src/bedoux/*.py`,
...
chapters (02–06) will add; none of it exists yet.
