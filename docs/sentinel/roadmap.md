...
| 02 | `series/02-quality-gate` | Defend before damage spreads | Demonstrated: fault → restore → replay all confirmed live in `dev` (see chapter doc). PR #3 open, CI green, pending merge | Not drafted |
