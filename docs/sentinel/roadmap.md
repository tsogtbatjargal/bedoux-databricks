...
| 02 | `series/02-quality-gate` | Defend before damage spreads | PR #3 open; implemented and locally tested, bundle validates, demonstration not yet run | Not drafted |
